...
def My_neural_network():
    ...
    my_model_trained = train_model(my_model, criterion, dataloader, dataloader1, optimizer, metrics, bpath, num_epochs=10)
    ...
    #-------------------- trying to save the model in some way ----------------------------------
